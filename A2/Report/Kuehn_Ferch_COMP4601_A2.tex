...
The ratings table is large (1252 rows x 1079 columns) and very sparse (93.9\%). We first reduced this to a dense, low-dimensional representation by the following process:
\begin{enumerate}
...
\section{Clustering movies according to page text}
